export const translations = {
  en: {
    ...
    importantDisclaimer: "Important Disclaimer",
    aiDisclaimerFull:
      "These are AI-generated suggestions only. Always consult with a qualified healthcare professional before taking any medication.",
    consultDoctor: "Consult Doctor",
  ...
  hi: {
    ...
    notes: "नोट्स",
      ...
      // Add corresponding Hindi translations for all the above keys
